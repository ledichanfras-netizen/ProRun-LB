    ...
    <div className="h-full bg-[#020617] flex flex-col md:flex-row font-sans text-slate-100 overflow-hidden">
      ...
      <div className="md:hidden bg-[#020617]/80 dark:bg-[#020617]/80 backdrop-blur-md text-white p-4 flex justify-between items-center sticky top-0 z-20 border-b border-white/5 no-print safe-top">
        <div className="flex items-center gap-2">
          <div className="w-9 h-9 logo-box bg-[#020617] rounded-xl p-0.5 border border-emerald-500/30 shadow-[0_0_15px_rgba(16,185,129,0.2)] flex items-center justify-center overflow-hidden">
            <img src="/prorunlb_pwa_192_with_text.png?v=10" alt="Logo" className="w-full h-full object-cover rounded-lg" referrerPolicy="no-referrer" />
          </div>
        ...
        <div className="flex items-center gap-3">
          <button 
            onClick={toggleTheme} 
            className="p-2 bg-white/10 dark:bg-white/5 hover:bg-white/20 rounded-xl transition-all border border-white/10 flex items-center justify-center text-emerald-400"
            title={theme === 'dark' ? "Ativar Modo Claro Elite" : "Ativar Modo Escuro"}
            aria-label="Alternar Modo Claro/Escuro"
          >
            {theme === 'dark' ? <Sun className="w-5 h-5 text-emerald-400" /> : <Moon className="w-5 h-5 text-indigo-400" />}
          </button>
      ...
      `}>
        <div className="p-8 flex items-center justify-between border-b border-white/5">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 logo-box bg-[#020617] p-0.5 rounded-2xl border border-emerald-500/30 shadow-[0_0_20px_rgba(16,185,129,0.15)] flex items-center justify-center overflow-hidden">
               <img src="/prorunlb_pwa_192_with_text.png?v=10" alt="Logo" className="w-full h-full object-cover rounded-[0.9rem]" referrerPolicy="no-referrer" />
            </div>
          ...
          <div className="flex items-center gap-1">
            <button 
              onClick={toggleTheme} 
              className="p-2 hover:bg-white/10 rounded-xl transition-all border border-transparent hover:border-white/10 text-emerald-400"
              title={theme === 'dark' ? "Ativar Modo Claro Elite" : "Ativar Modo Escuro"}
            >
              {theme === 'dark' ? <Sun className="w-5 h-5 text-emerald-400" /> : <Moon className="w-5 h-5 text-indigo-400" />}
            </button>
          ...
          {showInstallBanner && (
            <div id="install-area" className="relative overflow-hidden glass-card p-8 flex flex-col md:flex-row items-center justify-between gap-6 no-print animate-fade-in group">
              ...
              <div className="flex items-center gap-6 relative z-10">
                <div className="w-20 h-20 logo-box bg-[#020617] p-0.5 rounded-[1.5rem] shadow-2xl border border-emerald-500/30 overflow-hidden transform group-hover:rotate-6 transition-transform flex items-center justify-center">
                  <img src="/prorunlb_pwa_192_with_text.png?v=10" alt="ProRun Logo" className="w-full h-full object-cover rounded-[1.3rem]" referrerPolicy="no-referrer" />
                </div>
                <div>
