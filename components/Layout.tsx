      ...
      <div className="md:hidden bg-[#020617]/80 dark:bg-[#020617]/80 backdrop-blur-md text-white p-4 flex justify-between items-center sticky top-0 z-20 border-b border-white/5 no-print safe-top">
        <div className="flex items-center gap-2">
          <div className="w-9 h-9 logo-box bg-[#020617] rounded-xl p-0 border border-emerald-500/30 shadow-[0_0_15px_rgba(16,185,129,0.2)] flex items-center justify-center overflow-hidden">
            <img src="/prorunlb_pwa_192_with_text.png?v=11" alt="Logo" className="w-full h-full object-cover rounded-[0.7rem]" referrerPolicy="no-referrer" />
          </div>
        ...
        <div className="p-8 flex items-center justify-between border-b border-white/5">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 logo-box bg-[#020617] p-0 rounded-2xl border border-emerald-500/30 shadow-[0_0_20px_rgba(16,185,129,0.15)] flex items-center justify-center overflow-hidden">
               <img src="/prorunlb_pwa_192_with_text.png?v=11" alt="Logo" className="w-full h-full object-cover rounded-[0.95rem]" referrerPolicy="no-referrer" />
            </div>
            ...
            <div id="install-area" className="relative overflow-hidden glass-card p-8 flex flex-col md:flex-row items-center justify-between gap-6 no-print animate-fade-in group">
              ...
              <div className="flex items-center gap-6 relative z-10">
                <div className="w-20 h-20 logo-box bg-[#020617] p-0 rounded-[1.5rem] shadow-2xl border border-emerald-500/30 overflow-hidden transform group-hover:rotate-6 transition-transform flex items-center justify-center">
                  <img src="/prorunlb_pwa_192_with_text.png?v=11" alt="ProRun Logo" className="w-full h-full object-cover rounded-[1.5rem]" referrerPolicy="no-referrer" />
                </div>
                <div>
