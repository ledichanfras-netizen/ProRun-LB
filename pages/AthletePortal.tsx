...
const AthletePortal: React.FC = () => {
  ...
  // Helper to translate phase names - this function might be needed from the stashed changes
  const translatePhase = (phase: string) => {
    ...
    return translations[phase] || phase.toUpperCase();
  };
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 gap-4">
                    {(week.workouts || []).map((workout, dIdx) => (
                      ...
                      >
                        ...
                        {typeof workout.distance === 'number' && workout.distance > 0 && (
